...
public class Question {
	...
	public int questionboard() {
		...
		if (Login.loginMember == null) {
			System.out.print("(1)자주 묻는 질문 (2)뒤로가기 >");
			...
			System.out.print("(1)자주 묻는 질문 (2)1:1 문의 (3)뒤로가기 >");
			int result = ScanUtil.nextInt();
			switch (result) {
			case 1:
				return View.FAQBOARD;
	...
	public int question() {
		...
		System.out.print("(1)문의 (2)문의 결과 확인 (3)뒤로가기 >");
		int result = ScanUtil.nextInt();
		switch (result) {
		case 1:
			return View.QONE;
	...
	public int qadminanswer() {
		...
		System.out.print("(1)답변 등록 (2)뒤로가기 >");
	...
	public int faqboard() {
		...
		if (Login.loginMember == null) {
			...
			if (("admin").equals((String) Login.loginMember.get("ID"))) {
				System.out.print("(1)조회 (2)자주묻는 질문등록 (3)뒤로가기 >");
				int result = ScanUtil.nextInt();
				switch (result) {
				case 1:
					return View.FAQANSWER;
